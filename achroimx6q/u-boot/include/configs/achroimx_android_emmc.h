...
#ifndef __ACHROIMX_ANDROID_EMMC_H__
#define __ACHROIMX_ANDROID_EMMC_H__
...
#define CONFIG_FASTBOOT_MANUFACTURER_STR  "Huins"
#define CONFIG_FASTBOOT_PRODUCT_NAME_STR "AchroIMX6"
...
#define CONFIG_SYS_VIDEO_LOGO_MAX_SIZE (2 * 1048576)
